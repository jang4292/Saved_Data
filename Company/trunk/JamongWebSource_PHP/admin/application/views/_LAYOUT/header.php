...
<body ng-App="myApp" class="skin-red sidebar-mini">
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="<?= site_url('/home/index') ?>" class="logo">
            <span class="logo-lg"><b>ATTRACTION</b></span>
        </a>
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="col-xs-2" style="margin-top: 8px">
                <!--
                <select id="login_select_local" class="form-control">
                    <option value="korean">한국어</option>
                    <option value="japanese">日本語</option>
                </select>
                -->
                <select style="display:none" id="login_select_local" class="form-control" onchange="javascript:window.location.href='<?php echo base_url(); ?>LanguageSwitcher/switchLang/'+this.value;">
                    <option value="japanese" <?php if($this->session->userdata('site_lang') == 'japanese') echo 'selected="selected"'; ?>>日本語</option>
