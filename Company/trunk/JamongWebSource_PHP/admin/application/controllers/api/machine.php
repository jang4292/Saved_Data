...
class Machine extends CORE_Controller {
    ...
    function get_users()
    {
        ...
        $users = $this->machine_model->gets_pagination($page, $per_page, $sort, $filter);
        $total_count = $this->machine_model->get_total_count();
    ...
    function detail()
    {
        ...
        $user = $this->machine_model->get_user_by_id($user_id);
