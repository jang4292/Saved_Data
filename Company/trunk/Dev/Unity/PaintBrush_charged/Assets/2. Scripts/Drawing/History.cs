    ...
    public class History : MonoBehaviour
    {
        ...
        public void UnDo()
        {
            ...
            if (pool[pointer].type == Element.EType.Color)
            {
                ...
                if (element == null)
                {
                    pool[pointer].transform.GetComponent<CharacterPart>().SetColor(Color.white);
                    SetSortingOrder(pool[pointer].transform, pool[pointer].transform.GetComponent<CharacterPart>().initialSortingOrder);
                }
                else {
                    pool[pointer].transform.GetComponent<CharacterPart>().SetColor(element.color);
        ...
        public void Redo()
        {
            ...
            if (pool[pointer].type == Element.EType.Color)
            {
                pool[pointer].transform.GetComponent<CharacterPart>().SetColor(pool[pointer].color);
                SetSortingOrder(pool[pointer].transform, pool[pointer].sortingOrder);
            }
            else if (pool[pointer].type == Element.EType.Object)
            {
