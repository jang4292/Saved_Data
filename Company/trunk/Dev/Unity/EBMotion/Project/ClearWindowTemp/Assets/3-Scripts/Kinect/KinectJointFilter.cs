...
public class KinectJointFilter
{
    ...
    public void Init(float fSmoothing = 0.7f, float fCorrection = 0.3f, float fPrediction = 1.0f, float fJitterRadius = 1.0f, float fMaxDeviationRadius = 1.0f)
    {
    ...
    public void Reset(float fSmoothing = 0.7f, float fCorrection = 0.3f, float fPrediction = 1.0f, float fJitterRadius = 1.0f, float fMaxDeviationRadius = 1.0f)
    {
