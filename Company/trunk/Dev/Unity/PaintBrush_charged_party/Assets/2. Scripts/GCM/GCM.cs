...
namespace GoogleCloudMessage
{
    ...
    public class GCM
    {
        ...
        private const string CLASS_NAME = "com.mamp.paintbrush.gcm.UnityGCMRegister";
        ...
        public static void ShowToast(string message)
        {
            if (Application.platform == RuntimePlatform.Android)
            {
                using (AndroidJavaClass cls = new AndroidJavaClass("com.mamp.paintbrush.gcm.Util"))
                {
                    ;
